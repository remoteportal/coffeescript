...
(function() {
  // process: ENV={"node":true,"rn":false,"ut":true,"source":"/Users/pete/gitlab/rn/API/Flexbase/Util.coffee"}
  var EXPORTED, MMSS, N, NODE_util, O, RE_ISOLATE_TYPE, V, abort, assertFileURI, exitAfterSlightDelay__soThatLogCanFinishWriting, fileDownload, fs, fs_directoryDeleteRecursive, fs_directoryEnsure, latestGet, logBase, m_logEmptyNextCharacter, m_logStream, pickRnd, rnd, size_pr, type;

  /*
  Util - Utility Functions					*** PROJECT AGNOSTIC ***
  ...
  TODOs
  - Abstract file operations between node and RN
  ...
  */
  ...
  assertFileURI = function(directory) {
    if (!directory.startsWith("file:")) {
      throw new Error("NOT URI: {directory}");
    }
  };
  ...
  EXPORTED = {
    ...
    //EASY: add second parameter to ensure each leg
