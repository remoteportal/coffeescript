...
(function() {
  // process: ENV={"node":true,"rn":false,"ut":true,"source":"/Users/pete/gitlab/rn/API/Flexbase/S.coffee"}
  var C, CAP, COMPARE_REPORT, EXPORTED, F, HAS_INSERTED_TEXT_IN_MIDDLE, HEX, IS, PETER, V, autoTable, stringifySafe, trace;
  ...
  */
  ...
  autoTable = function(data, opts = {
    ...
    var bFound, buf, cn, columnMap, ignoreMap, j, l, len1, len2, o, pass, pre, ref, row;
    //	data = Object.assign {}, data
    pre = "";
    if (opts.grep) {
      pre = `filter: "${opts.grep}"`;
    ...
    if (Array.isArray(data)) {
      ...
      //		console.log buf
      if (opts.grep && buf.length === 0) {
        return pre + " => NO MATCHES";
      } else {
        return pre + buf;
      }
    } else {
