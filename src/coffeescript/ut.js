...
(function() {
  var B_FAIL_FAST, EXPORTED, INFINITE_LOOP_DETECTION_ITERATIONS, T, TESTNBR, UT, UT_UT, aGenerate, bHappy, bRan, bRunning, bag, decorate, decorateJustObject, fail, fnCallback, g_timer, handler, iterations, msStart, pass, path, proxyBag, sectionGenerate, t_depth, target, testGenerate, testIndex, testList, testListSaved, testStack,
    indexOf = [].indexOf;
