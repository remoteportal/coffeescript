...
tr.push "ANEW=modMap.ANEW; AP=modMap.AP; ASS=modMap.ASS; C=modMap.C; DATE=modMap.DATE; IS=modMap.IS; LL=modMap.LL; N=modMap.N; ONEW=modMap.ONEW; S=modMap.S; SP=modMap.SP; textFormat=modMap.textFormat; VNEW=modMap.VNEW"
